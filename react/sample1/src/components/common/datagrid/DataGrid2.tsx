...
import { TypeOnSelectionChangeArg, TypeRowExpandHeightFunction } from '@inovua/reactdatagrid-community/types/TypeDataGridProps';
...
interface DataGridProps<T> {
  ...
  //dataSource: any[] | Promise<{ data: any[]; count: number; }>;
  columns: TypeColumn[];
...
function DataGrid<T>(
  ...
  return (
    <ReactDataGrid
      licenseKey='AppName=multi_app,Company=app,ExpiryDate=2022-11-11,LicenseDeveloperCount=2,LicenseType=multi_app,Ref=appLicenseRef,Z=1207408073-10491456647810635194481521851207408073-517868438' 
      style={style}
